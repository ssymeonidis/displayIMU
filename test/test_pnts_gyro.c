...
int main(void)
{
  ...
  ****************************************************************************/
  ...
  test_datum(vec1, 0.04, IMU_pnts_enum_move,   0.08, out3b);

  // verify hold state
  float out4[3]  = {11.40, 20.0, 28.60};
  test_datum(vec1, 0.04, IMU_pnts_enum_hold,   0.12, out4);
  ...
  ****************************************************************************/
  ...
  test_datum(vec6, 0.04, IMU_pnts_enum_move,   0.08, out6b);

  // verify tStable clear
  float vec7[3]  = {10.00, 10.00, 10.00};
  float out7[3]  = {15.84, 18.55, 24.56};
  test_datum(vec7, 0.04, IMU_pnts_enum_move,   0.00, out7);
